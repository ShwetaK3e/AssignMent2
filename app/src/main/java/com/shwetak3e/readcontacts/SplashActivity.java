...
public class SplashActivity extends AppCompatActivity {
    ...
    private boolean permissionsGranted(){
        boolean readContact=getPermissionStatus(this, Manifest.permission.READ_CONTACTS);
        boolean readFiles=getPermissionStatus(this, Manifest.permission.READ_EXTERNAL_STORAGE);
        boolean writeFile=getPermissionStatus(this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        return (readContact && readFiles && writeFile);
    }
